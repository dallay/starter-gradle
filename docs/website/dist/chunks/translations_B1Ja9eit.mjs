import { z as objectType, B as dateType, C as arrayType, D as stringType, A as AstroError, G as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, H as escape$1, y as unescapeHTML, b as renderTemplate, J as renderUniqueStylesheet, K as renderScriptElement, O as createHeadAndContent, r as renderComponent, g as AstroUserError } from './astro/server_BZagVjeS.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_C2Dxd2uF.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Cj24u74Y.mjs').then(n => n._);
...
const starlightConfig = {"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Guides","translations":{},"collapsed":false,"items":[{"label":"Getting Started","translations":{},"slug":"en/guides/getting-started","attrs":{}},{"label":"Project Structure","translations":{},"slug":"en/guides/structure","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Starter Gradle"},"isMultilingual":true,"defaultLocale":{"label":"English","dir":"ltr","lang":"en","locale":"en"},"locales":{"en":{"label":"English","dir":"ltr","lang":"en"},"es":{"label":"Español","lang":"es","dir":"ltr"}}};

const project = {"build":{"format":"directory"},"root":"file:///app/docs/website/","srcDir":"file:///app/docs/website/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, getCollectionPathFromRoot as a, appendForwardSlash as b, getCollectionPath as c, DEFAULT_HASH_PROPS as d, stripTrailingSlash as e, getCollection as f, getEntry as g, stripLeadingSlash as h, isRemotePath as i, joinPaths as j, stripHtmlExtension as k, ensureHtmlExtension as l, ensureTrailingSlash as m, pickLang as n, stripLeadingAndTrailingSlashes as o, project as p, ensureLeadingSlash as q, removeTrailingForwardSlash as r, starlightConfig as s, stripExtension as t, useTranslations as u, DeprecatedLabelsPropProxy as v, renderEntry as w };
