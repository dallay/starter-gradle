...
async function createRegexEngine(engine) {
  if (engine === "javascript")
    return [undefined][0];
  return [(await import('./engine-oniguruma_Q1hyzL5x.mjs')).createOnigurumaEngine(import('./wasm_CmTHlobv.mjs'))][0];
}
